...
let g:which_key_map.h = {
      ...
      \ 'P'    : [':lua require("nvim-tree.api").tree.open(vim.g.plugin_cfg_dir) ', 'open-vimcfg-in-file-browser'],
...
let g:which_key_map.t = {
      ...
      \ 'f'    : [':FloatermToggle', 'float-term-toggle'],
      \ 'e'    : [':FloatermNext', 'float-term-next'],
      \ 'd'    : [':FloatermPrev', 'float-term-prev'],
...
let g:which_key_map.f = {
      ...
      \ 't'    : [':NvimTreeToggle', 'file-tree-browser-toggle'],
