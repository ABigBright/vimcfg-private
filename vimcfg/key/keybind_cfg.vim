...
let g:which_key_map.h = {
      ...
      \ 'P'    : [':exec "CocCommand explorer " . g:plugin_cfg_dir', 'open-vimcfg-in-file-browser'],
...
let g:which_key_map.f = {
      ...
      \ 't'    : [':CocCommand explorer', 'file-tree-browser-toggle'],
      \ 'c'    : [':CocCommand explorer', 'current-file-tree-browser'],
